...
#define CLIP_COUNT_999_CHECK_ADDRESS 0x0A0F05D // B9 E7 03 00 00 3B C1 0F 47 C1 48 83 C4 20 5B C3 +1 // A0F05C 1 10 163
#define RESERVE_COUNT_999_CHECK_ADDRESS 0x0A0F0DE // B9 E7 03 00 00 3B C1 0F 47 C1 48 83 C4 20 5B C3 +1 // A0F0DD 1 10 163
#define AMMO_COUNT_STRING_FORMAT_ADDRESS 0x2D140F8 // 84 C0 74 ? 44 8B 83 98 01 00 00  +0xB , 3 , 7 // 2D140F8 1 10 163
#define CLIP_COUNT_WAS_CHANGED_CHECK_ADDRESS 0x0A0EA6E // A0EA6E 1 10 163 (UpdateComponent +3ce)
#define RESERVE_COUNT_WAS_CHANGED_CHECK_ADDRESS 0x0A0EA0A // A0EA0A 1 10 163 (UpdateComponent +36a)
#define UPDATE_COMPONENT_HOOK_ADDRESS 0x2D13FD8 // 2D13FD8 1 10 163
...
//RelocAddr <_HUDAmmoCounter__UpdateComponent> HUDAmmoCounter__UpdateComponent(0x000A0E580); //A0E6A0  1 10 163
