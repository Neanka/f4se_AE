...
#define ScriptFunctionReg_HookTarget_ADDRESS 0x278D541 // E8 ? ? ? ? EB ? 49 8B C4 48 8B 95 08 01 00 00 ( 278D421 1 10 138)
#define ScriptFunctionReg_Original_ADDRESS 0x27AC870 // (27AC750 1 10 138)
#define ScriptFunction_Invoke_HookTarget_ADDRESS 0x3083630 // Unk_OF() (30835A0  1 10 138)
#define Message_Show_ADDRESS 0x13AF080// 89 54 24 10 55 53 57 41 54 41 56 41 57 48 8D 6C 24 88  (13AEF60  1 10 138)
...
public:
	...
	{
		flags = kFlag_AllowSaving | kFlag_DontHideCursorWhenTopmost | kFlag_CompanionAppAllowed | kFlag_CustomRendering | kFlag_AlwaysOpen;// | kFlag_HasButtonBar | kFlag_IsTopButtonBar | kFlag_RendersUnderPauseMenu;
		depth = 0x6;
