...
/*/0x1403eb200 - 140414F60
struct unk414F60Event{

};
DECLARE_EVENT_DISPATCHER(unk414F60Event, 0x414f60);
...
//0x140434630 - 140441110
struct unk441110Event{

};
DECLARE_EVENT_DISPATCHER(unk441110Event, 0x441110);

class unk441110EventSink : public BSTEventSink<unk441110Event>
{
public:
	virtual	EventResult	ReceiveEvent(unk441110Event * evn, void * dispatcher) override
	{
		_MESSAGE("unk441110Event:");
		return kEvent_Continue;
	}
};

unk441110EventSink _unk441110EventSink;

//0x1404346c0 - 1404443B0
struct unk4443B0Event{

};
DECLARE_EVENT_DISPATCHER(unk4443B0Event, 0x4443b0);

class unk4443B0EventSink : public BSTEventSink<unk4443B0Event>
{
public:
	virtual	EventResult	ReceiveEvent(unk4443B0Event * evn, void * dispatcher) override
	{
		_MESSAGE("unk4443B0Event:");
		return kEvent_Continue;
	}
};

unk4443B0EventSink _unk4443B0EventSink;

//0x140434780 - 140441B10
struct unk441B10Event{

};
DECLARE_EVENT_DISPATCHER(unk441B10Event, 0x441b10);

class unk441B10EventSink : public BSTEventSink<unk441B10Event>
{
public:
	virtual	EventResult	ReceiveEvent(unk441B10Event * evn, void * dispatcher) override
	{
		_MESSAGE("unk441B10Event:");
		return kEvent_Continue;
	}
};

unk441B10EventSink _unk441B10EventSink;

//0x140434880 - 1404428D0
struct unk4428D0Event{

};
DECLARE_EVENT_DISPATCHER(unk4428D0Event, 0x4428d0);

class unk4428D0EventSink : public BSTEventSink<unk4428D0Event>
{
public:
	virtual	EventResult	ReceiveEvent(unk4428D0Event * evn, void * dispatcher) override
	{
		_MESSAGE("unk4428D0Event:");
		return kEvent_Continue;
	}
};

unk4428D0EventSink _unk4428D0EventSink;

//0x140434980 - 140441BB0
struct unk441BB0Event{

};
DECLARE_EVENT_DISPATCHER(unk441BB0Event, 0x441bb0);

class unk441BB0EventSink : public BSTEventSink<unk441BB0Event>
{
public:
	virtual	EventResult	ReceiveEvent(unk441BB0Event * evn, void * dispatcher) override
	{
		_MESSAGE("unk441BB0Event:");
		return kEvent_Continue;
	}
};

unk441BB0EventSink _unk441BB0EventSink;

//0x140434a90 - 140441C50
struct unk441C50Event{

};
DECLARE_EVENT_DISPATCHER(unk441C50Event, 0x441c50);

class unk441C50EventSink : public BSTEventSink<unk441C50Event>
{
public:
	virtual	EventResult	ReceiveEvent(unk441C50Event * evn, void * dispatcher) override
	{
		_MESSAGE("unk441C50Event:");
		return kEvent_Continue;
	}
};

unk441C50EventSink _unk441C50EventSink;

//0x140434b60 - 140441CF0
struct unk441CF0Event{

};
DECLARE_EVENT_DISPATCHER(unk441CF0Event, 0x441cf0);

class unk441CF0EventSink : public BSTEventSink<unk441CF0Event>
{
public:
	virtual	EventResult	ReceiveEvent(unk441CF0Event * evn, void * dispatcher) override
	{
		_MESSAGE("unk441CF0Event:");
		return kEvent_Continue;
	}
};

unk441CF0EventSink _unk441CF0EventSink;

//0x140434c90 - 140441D90
struct unk441D90Event{

};
DECLARE_EVENT_DISPATCHER(unk441D90Event, 0x441d90);

class unk441D90EventSink : public BSTEventSink<unk441D90Event>
{
public:
	virtual	EventResult	ReceiveEvent(unk441D90Event * evn, void * dispatcher) override
	{
		_MESSAGE("unk441D90Event:");
		return kEvent_Continue;
	}
};

unk441D90EventSink _unk441D90EventSink;

//0x140434d80 - 140441E30
struct unk441E30Event{

};
DECLARE_EVENT_DISPATCHER(unk441E30Event, 0x441e30);

class unk441E30EventSink : public BSTEventSink<unk441E30Event>
{
public:
	virtual	EventResult	ReceiveEvent(unk441E30Event * evn, void * dispatcher) override
	{
		_MESSAGE("unk441E30Event:");
		return kEvent_Continue;
	}
};

unk441E30EventSink _unk441E30EventSink;

//0x140434e40 - 140441ED0
struct unk441ED0Event{

};
DECLARE_EVENT_DISPATCHER(unk441ED0Event, 0x441ed0);

class unk441ED0EventSink : public BSTEventSink<unk441ED0Event>
{
public:
	virtual	EventResult	ReceiveEvent(unk441ED0Event * evn, void * dispatcher) override
	{
		_MESSAGE("unk441ED0Event:");
		return kEvent_Continue;
	}
};

unk441ED0EventSink _unk441ED0EventSink;

//0x140434ea0 - 140441F70
struct unk441F70Event{

};
DECLARE_EVENT_DISPATCHER(unk441F70Event, 0x441f70);

class unk441F70EventSink : public BSTEventSink<unk441F70Event>
{
public:
	virtual	EventResult	ReceiveEvent(unk441F70Event * evn, void * dispatcher) override
	{
		_MESSAGE("unk441F70Event:");
		return kEvent_Continue;
	}
};

unk441F70EventSink _unk441F70EventSink;
...
struct unkFE6DB0Event{

};
DECLARE_EVENT_DISPATCHER(unkFE6DB0Event, 0xfe6db0);

class unkFE6DB0EventSink : public BSTEventSink<unkFE6DB0Event>
{
public:
	virtual	EventResult	ReceiveEvent(unkFE6DB0Event * evn, void * dispatcher) override
	{
		_MESSAGE("unkFE6DB0Event:");
		return kEvent_Continue;
	}
};

unkFE6DB0EventSink _unkFE6DB0EventSink;
...
void registerXeventsX()
{
	DumpClass(GetEventDispatcher<unk443A50Event>()->eventSinks.entries, 30);
	DumpClass(GetEventDispatcher<unk443E10Event>()->eventSinks.entries, 30);
	DumpClass(GetEventDispatcher<unk443910Event>()->eventSinks.entries, 30);
	DumpClass(GetEventDispatcher<unk4439B0Event>()->eventSinks.entries, 30);
}

void registerXevents()
{
...
//GetEventDispatcher<unk414F60Event>()->AddEventSink(&_unk414F60EventSink);
//_MESSAGE("unk414F60Event: registered");
GetEventDispatcher<unk441110Event>()->AddEventSink(&_unk441110EventSink);
_MESSAGE("unk441110Event: registered");
GetEventDispatcher<unk4443B0Event>()->AddEventSink(&_unk4443B0EventSink);
_MESSAGE("unk4443B0Event: registered");
GetEventDispatcher<unk441B10Event>()->AddEventSink(&_unk441B10EventSink);
_MESSAGE("unk441B10Event: registered");
GetEventDispatcher<unk4428D0Event>()->AddEventSink(&_unk4428D0EventSink);
_MESSAGE("unk4428D0Event: registered");
GetEventDispatcher<unk441BB0Event>()->AddEventSink(&_unk441BB0EventSink);
_MESSAGE("unk441BB0Event: registered");
GetEventDispatcher<unk441C50Event>()->AddEventSink(&_unk441C50EventSink);
_MESSAGE("unk441C50Event: registered");
GetEventDispatcher<unk441CF0Event>()->AddEventSink(&_unk441CF0EventSink);
_MESSAGE("unk441CF0Event: registered");
GetEventDispatcher<unk441D90Event>()->AddEventSink(&_unk441D90EventSink);
_MESSAGE("unk441D90Event: registered");
GetEventDispatcher<unk441E30Event>()->AddEventSink(&_unk441E30EventSink);
_MESSAGE("unk441E30Event: registered");
GetEventDispatcher<unk441ED0Event>()->AddEventSink(&_unk441ED0EventSink);
_MESSAGE("unk441ED0Event: registered");
GetEventDispatcher<unk441F70Event>()->AddEventSink(&_unk441F70EventSink);
_MESSAGE("unk441F70Event: registered");
GetEventDispatcher<unk442010Event>()->AddEventSink(&_unk442010EventSink);
_MESSAGE("unk442010Event: registered");
GetEventDispatcher<unk4420B0Event>()->AddEventSink(&_unk4420B0EventSink);
_MESSAGE("unk4420B0Event: registered");
GetEventDispatcher<unk442150Event>()->AddEventSink(&_unk442150EventSink);
_MESSAGE("unk442150Event: registered");
GetEventDispatcher<unk4421F0Event>()->AddEventSink(&_unk4421F0EventSink);
_MESSAGE("unk4421F0Event: registered");
GetEventDispatcher<unk442330Event>()->AddEventSink(&_unk442330EventSink);
_MESSAGE("unk442330Event: registered");
GetEventDispatcher<unk4411B0Event>()->AddEventSink(&_unk4411B0EventSink);
_MESSAGE("unk4411B0Event: registered");
GetEventDispatcher<unk442470Event>()->AddEventSink(&_unk442470EventSink);
_MESSAGE("unk442470Event: registered");
GetEventDispatcher<unk4423D0Event>()->AddEventSink(&_unk4423D0EventSink);
_MESSAGE("unk4423D0Event: registered");
GetEventDispatcher<unk442510Event>()->AddEventSink(&_unk442510EventSink);
_MESSAGE("unk442510Event: registered");
GetEventDispatcher<unk4425B0Event>()->AddEventSink(&_unk4425B0EventSink);
_MESSAGE("unk4425B0Event: registered");
GetEventDispatcher<unk442650Event>()->AddEventSink(&_unk442650EventSink);
_MESSAGE("unk442650Event: registered");
GetEventDispatcher<unk442790Event>()->AddEventSink(&_unk442790EventSink);
_MESSAGE("unk442790Event: registered");
GetEventDispatcher<unk442830Event>()->AddEventSink(&_unk442830EventSink);
_MESSAGE("unk442830Event: registered");
GetEventDispatcher<unk4426F0Event>()->AddEventSink(&_unk4426F0EventSink);
_MESSAGE("unk4426F0Event: registered");
GetEventDispatcher<unk442970Event>()->AddEventSink(&_unk442970EventSink);
_MESSAGE("unk442970Event: registered");
GetEventDispatcher<unk442A10Event>()->AddEventSink(&_unk442A10EventSink);
_MESSAGE("unk442A10Event: registered");
GetEventDispatcher<unk442AB0Event>()->AddEventSink(&_unk442AB0EventSink);
_MESSAGE("unk442AB0Event: registered");
GetEventDispatcher<unk442B50Event>()->AddEventSink(&_unk442B50EventSink);
_MESSAGE("unk442B50Event: registered");
GetEventDispatcher<unk4444F0Event>()->AddEventSink(&_unk4444F0EventSink);
_MESSAGE("unk4444F0Event: registered");
GetEventDispatcher<unk4419D0Event>()->AddEventSink(&_unk4419D0EventSink);
_MESSAGE("unk4419D0Event: registered");
GetEventDispatcher<unk441A70Event>()->AddEventSink(&_unk441A70EventSink);
_MESSAGE("unk441A70Event: registered");
GetEventDispatcher<unk444450Event>()->AddEventSink(&_unk444450EventSink);
_MESSAGE("unk444450Event: registered");
GetEventDispatcher<unk442BF0Event>()->AddEventSink(&_unk442BF0EventSink);
_MESSAGE("unk442BF0Event: registered");
GetEventDispatcher<unk442DD0Event>()->AddEventSink(&_unk442DD0EventSink);
_MESSAGE("unk442DD0Event: registered");
GetEventDispatcher<unk442E70Event>()->AddEventSink(&_unk442E70EventSink);
_MESSAGE("unk442E70Event: registered");
GetEventDispatcher<unk442D30Event>()->AddEventSink(&_unk442D30EventSink);
_MESSAGE("unk442D30Event: registered");
GetEventDispatcher<unk442F10Event>()->AddEventSink(&_unk442F10EventSink);
_MESSAGE("unk442F10Event: registered");
GetEventDispatcher<unk442FB0Event>()->AddEventSink(&_unk442FB0EventSink);
_MESSAGE("unk442FB0Event: registered");
GetEventDispatcher<unk443050Event>()->AddEventSink(&_unk443050EventSink);
_MESSAGE("unk443050Event: registered");
GetEventDispatcher<unk443230Event>()->AddEventSink(&_unk443230EventSink);
_MESSAGE("unk443230Event: registered");
GetEventDispatcher<unk4432D0Event>()->AddEventSink(&_unk4432D0EventSink);
_MESSAGE("unk4432D0Event: registered");
GetEventDispatcher<unk443370Event>()->AddEventSink(&_unk443370EventSink);
_MESSAGE("unk443370Event: registered");
GetEventDispatcher<unk4434B0Event>()->AddEventSink(&_unk4434B0EventSink);
_MESSAGE("unk4434B0Event: registered");
GetEventDispatcher<unk443550Event>()->AddEventSink(&_unk443550EventSink);
_MESSAGE("unk443550Event: registered");
GetEventDispatcher<unk4435F0Event>()->AddEventSink(&_unk4435F0EventSink);
_MESSAGE("unk4435F0Event: registered");
GetEventDispatcher<unk443690Event>()->AddEventSink(&_unk443690EventSink);
_MESSAGE("unk443690Event: registered");
GetEventDispatcher<unk443730Event>()->AddEventSink(&_unk443730EventSink);
_MESSAGE("unk443730Event: registered");
GetEventDispatcher<unk4437D0Event>()->AddEventSink(&_unk4437D0EventSink);
_MESSAGE("unk4437D0Event: registered");
GetEventDispatcher<unk443870Event>()->AddEventSink(&_unk443870EventSink);
_MESSAGE("unk443870Event: registered");
//GetEventDispatcher<unk4439B0Event>()->AddEventSink(&_unk4439B0EventSink);
//_MESSAGE("unk4439B0Event: registered");
//GetEventDispatcher<unk443910Event>()->AddEventSink(&_unk443910EventSink);
//_MESSAGE("unk443910Event: registered");
//GetEventDispatcher<unk443A50Event>()->AddEventSink(&_unk443A50EventSink);
//_MESSAGE("unk443A50Event: registered");
GetEventDispatcher<unk443AF0Event>()->AddEventSink(&_unk443AF0EventSink);
_MESSAGE("unk443AF0Event: registered");
GetEventDispatcher<unk443B90Event>()->AddEventSink(&_unk443B90EventSink);
_MESSAGE("unk443B90Event: registered");
GetEventDispatcher<unk443C30Event>()->AddEventSink(&_unk443C30EventSink);
_MESSAGE("unk443C30Event: registered");
GetEventDispatcher<unk443CD0Event>()->AddEventSink(&_unk443CD0EventSink);
_MESSAGE("unk443CD0Event: registered");
//GetEventDispatcher<unk443E10Event>()->AddEventSink(&_unk443E10EventSink);
//_MESSAGE("unk443E10Event: registered");
GetEventDispatcher<unk443EB0Event>()->AddEventSink(&_unk443EB0EventSink);
_MESSAGE("unk443EB0Event: registered");
GetEventDispatcher<unk4430F0Event>()->AddEventSink(&_unk4430F0EventSink);
_MESSAGE("unk4430F0Event: registered");
GetEventDispatcher<unk443F50Event>()->AddEventSink(&_unk443F50EventSink);
_MESSAGE("unk443F50Event: registered");
GetEventDispatcher<unk444090Event>()->AddEventSink(&_unk444090EventSink);
_MESSAGE("unk444090Event: registered");
GetEventDispatcher<unk443FF0Event>()->AddEventSink(&_unk443FF0EventSink);
_MESSAGE("unk443FF0Event: registered");
GetEventDispatcher<unk444130Event>()->AddEventSink(&_unk444130EventSink);
_MESSAGE("unk444130Event: registered");
GetEventDispatcher<unk4441D0Event>()->AddEventSink(&_unk4441D0EventSink);
_MESSAGE("unk4441D0Event: registered");
GetEventDispatcher<unk444270Event>()->AddEventSink(&_unk444270EventSink);
_MESSAGE("unk444270Event: registered");
GetEventDispatcher<unk444310Event>()->AddEventSink(&_unk444310EventSink);
_MESSAGE("unk444310Event: registered");
GetEventDispatcher<unk443D70Event>()->AddEventSink(&_unk443D70EventSink);
_MESSAGE("unk443D70Event: registered");
GetEventDispatcher<unk442290Event>()->AddEventSink(&_unk442290EventSink);
_MESSAGE("unk442290Event: registered");
GetEventDispatcher<unk442C90Event>()->AddEventSink(&_unk442C90EventSink);
_MESSAGE("unk442C90Event: registered");
GetEventDispatcher<unk443410Event>()->AddEventSink(&_unk443410EventSink);
_MESSAGE("unk443410Event: registered");
GetEventDispatcher<unk443190Event>()->AddEventSink(&_unk443190EventSink);
_MESSAGE("unk443190Event: registered");
GetEventDispatcher<unk441930Event>()->AddEventSink(&_unk441930EventSink);
_MESSAGE("unk441930Event: registered");
GetEventDispatcher<unk441570Event>()->AddEventSink(&_unk441570EventSink);
_MESSAGE("unk441570Event: registered");
GetEventDispatcher<unk441250Event>()->AddEventSink(&_unk441250EventSink);
_MESSAGE("unk441250Event: registered");
GetEventDispatcher<unk441430Event>()->AddEventSink(&_unk441430EventSink);
_MESSAGE("unk441430Event: registered");
GetEventDispatcher<unk441610Event>()->AddEventSink(&_unk441610EventSink);
_MESSAGE("unk441610Event: registered");
GetEventDispatcher<unk4412F0Event>()->AddEventSink(&_unk4412F0EventSink);
_MESSAGE("unk4412F0Event: registered");
GetEventDispatcher<unk4416B0Event>()->AddEventSink(&_unk4416B0EventSink);
_MESSAGE("unk4416B0Event: registered");
GetEventDispatcher<unk4414D0Event>()->AddEventSink(&_unk4414D0EventSink);
_MESSAGE("unk4414D0Event: registered");
GetEventDispatcher<unk441750Event>()->AddEventSink(&_unk441750EventSink);
_MESSAGE("unk441750Event: registered");
GetEventDispatcher<unk441390Event>()->AddEventSink(&_unk441390EventSink);
_MESSAGE("unk441390Event: registered");
GetEventDispatcher<unk4417F0Event>()->AddEventSink(&_unk4417F0EventSink);
_MESSAGE("unk4417F0Event: registered");
GetEventDispatcher<unk441890Event>()->AddEventSink(&_unk441890EventSink);
_MESSAGE("unk441890Event: registered");
GetEventDispatcher<unk4A9120Event>()->AddEventSink(&_unk4A9120EventSink);
_MESSAGE("unk4A9120Event: registered");
GetEventDispatcher<unk571710Event>()->AddEventSink(&_unk571710EventSink);
_MESSAGE("unk571710Event: registered");
GetEventDispatcher<unk577B50Event>()->AddEventSink(&_unk577B50EventSink);
_MESSAGE("unk577B50Event: registered");
GetEventDispatcher<unk5E2DB0Event>()->AddEventSink(&_unk5E2DB0EventSink);
_MESSAGE("unk5E2DB0Event: registered");
GetEventDispatcher<unk5E2E50Event>()->AddEventSink(&_unk5E2E50EventSink);
_MESSAGE("unk5E2E50Event: registered");
GetEventDispatcher<unkB87FA0Event>()->AddEventSink(&_unkB87FA0EventSink);
_MESSAGE("unkB87FA0Event: registered");
GetEventDispatcher<unkB88040Event>()->AddEventSink(&_unkB88040EventSink);
_MESSAGE("unkB88040Event: registered");
GetEventDispatcher<unkB880E0Event>()->AddEventSink(&_unkB880E0EventSink);
_MESSAGE("unkB880E0Event: registered");
GetEventDispatcher<unkBB8140Event>()->AddEventSink(&_unkBB8140EventSink);
_MESSAGE("unkBB8140Event: registered");
GetEventDispatcher<unkD1E080Event>()->AddEventSink(&_unkD1E080EventSink);
_MESSAGE("unkD1E080Event: registered");
GetEventDispatcher<unkD1E150Event>()->AddEventSink(&_unkD1E150EventSink);
_MESSAGE("unkD1E150Event: registered");
GetEventDispatcher<unkDC5990Event>()->AddEventSink(&_unkDC5990EventSink);
_MESSAGE("unkDC5990Event: registered");
GetEventDispatcher<unkDC5A70Event>()->AddEventSink(&_unkDC5A70EventSink);
_MESSAGE("unkDC5A70Event: registered");
GetEventDispatcher<unkDC5CF0Event>()->AddEventSink(&_unkDC5CF0EventSink);
_MESSAGE("unkDC5CF0Event: registered");
GetEventDispatcher<unkDC5DC0Event>()->AddEventSink(&_unkDC5DC0EventSink);
_MESSAGE("unkDC5DC0Event: registered");
GetEventDispatcher<unkDC5E90Event>()->AddEventSink(&_unkDC5E90EventSink);
_MESSAGE("unkDC5E90Event: registered");
GetEventDispatcher<unkDC5B40Event>()->AddEventSink(&_unkDC5B40EventSink);
_MESSAGE("unkDC5B40Event: registered");
GetEventDispatcher<unkDC5C20Event>()->AddEventSink(&_unkDC5C20EventSink);
_MESSAGE("unkDC5C20Event: registered");
GetEventDispatcher<unkDF9100Event>()->AddEventSink(&_unkDF9100EventSink);
_MESSAGE("unkDF9100Event: registered");
GetEventDispatcher<unkE07590Event>()->AddEventSink(&_unkE07590EventSink);
_MESSAGE("unkE07590Event: registered");
GetEventDispatcher<unkE07630Event>()->AddEventSink(&_unkE07630EventSink);
_MESSAGE("unkE07630Event: registered");
GetEventDispatcher<unkE15A20Event>()->AddEventSink(&_unkE15A20EventSink);
_MESSAGE("unkE15A20Event: registered");
GetEventDispatcher<unkE15B00Event>()->AddEventSink(&_unkE15B00EventSink);
_MESSAGE("unkE15B00Event: registered");
GetEventDispatcher<unkEC1F80Event>()->AddEventSink(&_unkEC1F80EventSink);
_MESSAGE("unkEC1F80Event: registered");
GetEventDispatcher<unkEC2060Event>()->AddEventSink(&_unkEC2060EventSink);
_MESSAGE("unkEC2060Event: registered");
GetEventDispatcher<unkEC2100Event>()->AddEventSink(&_unkEC2100EventSink);
_MESSAGE("unkEC2100Event: registered");
GetEventDispatcher<unkEC21A0Event>()->AddEventSink(&_unkEC21A0EventSink);
_MESSAGE("unkEC21A0Event: registered");
GetEventDispatcher<unkEC2240Event>()->AddEventSink(&_unkEC2240EventSink);
_MESSAGE("unkEC2240Event: registered");
GetEventDispatcher<unkEC22E0Event>()->AddEventSink(&_unkEC22E0EventSink);
_MESSAGE("unkEC22E0Event: registered");
GetEventDispatcher<unkEC2380Event>()->AddEventSink(&_unkEC2380EventSink);
_MESSAGE("unkEC2380Event: registered");
GetEventDispatcher<unkEC2420Event>()->AddEventSink(&_unkEC2420EventSink);
_MESSAGE("unkEC2420Event: registered");
GetEventDispatcher<unkEC24C0Event>()->AddEventSink(&_unkEC24C0EventSink);
_MESSAGE("unkEC24C0Event: registered");
GetEventDispatcher<unkEC2560Event>()->AddEventSink(&_unkEC2560EventSink);
_MESSAGE("unkEC2560Event: registered");
GetEventDispatcher<unkEC2600Event>()->AddEventSink(&_unkEC2600EventSink);
_MESSAGE("unkEC2600Event: registered");
GetEventDispatcher<unkEC26A0Event>()->AddEventSink(&_unkEC26A0EventSink);
_MESSAGE("unkEC26A0Event: registered");
GetEventDispatcher<unkEC2740Event>()->AddEventSink(&_unkEC2740EventSink);
_MESSAGE("unkEC2740Event: registered");
GetEventDispatcher<unkEC27E0Event>()->AddEventSink(&_unkEC27E0EventSink);
_MESSAGE("unkEC27E0Event: registered");
GetEventDispatcher<unkEC2880Event>()->AddEventSink(&_unkEC2880EventSink);
_MESSAGE("unkEC2880Event: registered");
GetEventDispatcher<unkEC2920Event>()->AddEventSink(&_unkEC2920EventSink);
_MESSAGE("unkEC2920Event: registered");
GetEventDispatcher<unkEC29C0Event>()->AddEventSink(&_unkEC29C0EventSink);
_MESSAGE("unkEC29C0Event: registered");
GetEventDispatcher<unkEC2A60Event>()->AddEventSink(&_unkEC2A60EventSink);
_MESSAGE("unkEC2A60Event: registered");
GetEventDispatcher<unkEC2B00Event>()->AddEventSink(&_unkEC2B00EventSink);
_MESSAGE("unkEC2B00Event: registered");
GetEventDispatcher<unkEC2BA0Event>()->AddEventSink(&_unkEC2BA0EventSink);
_MESSAGE("unkEC2BA0Event: registered");
GetEventDispatcher<unkEC2C40Event>()->AddEventSink(&_unkEC2C40EventSink);
_MESSAGE("unkEC2C40Event: registered");
GetEventDispatcher<unkEC2CE0Event>()->AddEventSink(&_unkEC2CE0EventSink);
_MESSAGE("unkEC2CE0Event: registered");
GetEventDispatcher<unkEC2D80Event>()->AddEventSink(&_unkEC2D80EventSink);
_MESSAGE("unkEC2D80Event: registered");
GetEventDispatcher<unkEC2E20Event>()->AddEventSink(&_unkEC2E20EventSink);
_MESSAGE("unkEC2E20Event: registered");
GetEventDispatcher<unkEC2EC0Event>()->AddEventSink(&_unkEC2EC0EventSink);
_MESSAGE("unkEC2EC0Event: registered");
GetEventDispatcher<unkEC2F60Event>()->AddEventSink(&_unkEC2F60EventSink);
_MESSAGE("unkEC2F60Event: registered");
GetEventDispatcher<unkEC3000Event>()->AddEventSink(&_unkEC3000EventSink);
_MESSAGE("unkEC3000Event: registered");
GetEventDispatcher<unkEC30A0Event>()->AddEventSink(&_unkEC30A0EventSink);
_MESSAGE("unkEC30A0Event: registered");
GetEventDispatcher<unkEC3140Event>()->AddEventSink(&_unkEC3140EventSink);
_MESSAGE("unkEC3140Event: registered");
GetEventDispatcher<unkEC31E0Event>()->AddEventSink(&_unkEC31E0EventSink);
_MESSAGE("unkEC31E0Event: registered");
GetEventDispatcher<unkEC3280Event>()->AddEventSink(&_unkEC3280EventSink);
_MESSAGE("unkEC3280Event: registered");
GetEventDispatcher<unkEC3320Event>()->AddEventSink(&_unkEC3320EventSink);
_MESSAGE("unkEC3320Event: registered");
GetEventDispatcher<unkEC33C0Event>()->AddEventSink(&_unkEC33C0EventSink);
_MESSAGE("unkEC33C0Event: registered");
GetEventDispatcher<unkEC3460Event>()->AddEventSink(&_unkEC3460EventSink);
_MESSAGE("unkEC3460Event: registered");
GetEventDispatcher<unkEC3500Event>()->AddEventSink(&_unkEC3500EventSink);
_MESSAGE("unkEC3500Event: registered");
GetEventDispatcher<unkEC35A0Event>()->AddEventSink(&_unkEC35A0EventSink);
_MESSAGE("unkEC35A0Event: registered");
GetEventDispatcher<unkEC3670Event>()->AddEventSink(&_unkEC3670EventSink);
_MESSAGE("unkEC3670Event: registered");
GetEventDispatcher<unkE96DD0Event>()->AddEventSink(&_unkE96DD0EventSink);
_MESSAGE("unkE96DD0Event: registered");
GetEventDispatcher<unkF45770Event>()->AddEventSink(&_unkF45770EventSink);
_MESSAGE("unkF45770Event: registered");
GetEventDispatcher<unkF5BB00Event>()->AddEventSink(&_unkF5BB00EventSink);
_MESSAGE("unkF5BB00Event: registered");
GetEventDispatcher<unkFD9350Event>()->AddEventSink(&_unkFD9350EventSink);
_MESSAGE("unkFD9350Event: registered");
GetEventDispatcher<unkFE6DB0Event>()->AddEventSink(&_unkFE6DB0EventSink);
_MESSAGE("unkFE6DB0Event: registered");
GetEventDispatcher<unk127D6B0Event>()->AddEventSink(&_unk127D6B0EventSink);
_MESSAGE("unk127D6B0Event: registered");
GetEventDispatcher<unk127D750Event>()->AddEventSink(&_unk127D750EventSink);
_MESSAGE("unk127D750Event: registered");
GetEventDispatcher<unk129E7B0Event>()->AddEventSink(&_unk129E7B0EventSink);
_MESSAGE("unk129E7B0Event: registered");
GetEventDispatcher<unk12B1380Event>()->AddEventSink(&_unk12B1380EventSink);
_MESSAGE("unk12B1380Event: registered");
GetEventDispatcher<unk1B0F970Event>()->AddEventSink(&_unk1B0F970EventSink);
_MESSAGE("unk1B0F970Event: registered");
//GetEventDispatcher<unk1B15F80Event>()->AddEventSink(&_unk1B15F80EventSink);
//_MESSAGE("unk1B15F80Event: registered");
}